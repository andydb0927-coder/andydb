...
const definitions: DemoDefinition[] = [
  {
    ...
    title: '霜河渡',
    author: '无线画布',
    tags: ['长叙事', '精选画布', '专业影视', '国风', '雨夜'],
    coverUrl: withAppBase('/demo/shot-river.png'),
  ...
  },
  {
    ...
    title: '屋顶来信',
    author: '林野',
    tags: ['长叙事', '精选画布', '专业影视', '城市', '电影感'],
    coverUrl: withAppBase('/demo/shot-rooftop.png'),
  ...
  },
  {
    ...
    author: '阿遥',
    tags: ['短剧漫剧', '雨夜', '氛围', '短片'],
    coverUrl: withAppBase('/demo/scene-rain-street.png'),
